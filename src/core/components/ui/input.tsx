...
const inputVariants = cva(
  'border rounded-lg font-semibold active:outline-none disabled:opacity-50 w-full focus-visible:outline-purple-500 ',
  {
    variants: {
      variant: {
        default:
        ...
        ghost:
          'hover:border-slate-300  focus:border-slate-300 focus:ring-1 focus:ring-slate-200 focus:ring-opacity-50 disabled:bg-gray-100 disabled:border-gray-100 border-transparent',
